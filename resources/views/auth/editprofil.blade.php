        ...
        <div class="flex flex-col px-4 py-6">
            ...
            <div class="mb-4">
                <label for="namaLengkap" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Nama
                    Lengkap</label>
                <input type="text" placeholder="Masukkan nama lengkap" id="namaLengkap" name="name" value="{{ $user->name }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Masukkan jabatan" id="jabatan" name="jabatan" value="{{ $user->jabatan }}"
                    class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
            </div>
            <!-- Kolom e-Mail -->
            <div class="mb-3">
                <label for="email" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">e-Mail</label>
                <input type="email" placeholder="Masukkan e-Mail" id="email" name="email" value="{{ $user->email }}"
                    class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
            </div>
            <!-- Kolom Password Baru -->
            <div class="mb-3">
                <label for="newpassword" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Password
                    Baru</label>
                <input type="password" placeholder="Masukkan password baru" id="newpassword" name="newpassword"
                    class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
            </div>
            <!-- Kolom Konfirmasi Password Baru -->
            <div class="mb-5">
                <label for="confirmnewpassword" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Konfirmasi
                    Password Baru</label>
