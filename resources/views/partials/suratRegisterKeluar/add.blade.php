...
@section('container')
    ...
    <div id="myMaincontent" class="flex-1 flex flex-col overflow-hidden font-Poppins relative">
        ...
        <div class="flex flex-col px-4 py-6">
            ...
            <form action="{{ route('dashboard.surat-register-keluar.store') }}" method="post">
                @csrf
                <div class="mb-4">
                    <label for="namaLengkap" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Nama
                        Lengkap</label>
                    <input type="text" placeholder="Masukkan nama lengkap" id="namaLengkap" name="nama_lengkap" required
                ...
                <div class="mb-4">
                    ...
                    <input type="number" placeholder="Masukkan NIK" id="nik" name="nik" required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('nik')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <div
                        ...
                        <input type="date" placeholder="dd/mm/yyyy" id="tanggalLahir" name="tanggal_lahir" required
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="Masukkan status" id="status" name="status" required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('status')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-4">
                    <label for="jenisKelamin" class="text-sm font-medium tracking-wide text-stone-900 mb-0.5">Jenis
                        Kelamin</label>
                    <input type="text" placeholder="Masukkan jenis kelamin" id="jenisKelamin" name="jenis_kelamin"
                        required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('jenis_kelamin')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="Masukkan pekerjaan" id="pekerjaan" name="pekerjaan" required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('pekerjaan')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-4">
                    <label for="alamatAsal" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Alamat
                        Asal</label>
                    <input type="text" placeholder="Masukkan alamat asal" id="alamatAsal" name="alamat_asal" required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('alamat_asal')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-4">
                    <label for="alamatPindah" class="text-stone-900 text-sm font-medium tracking-wide mb-0.5">Alamat
                        Pindah</label>
                    <input type="text" placeholder="Masukkan alamat pindah" id="alamatPindah" name="alamat_pindah"
                        required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('alamat_pindah')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                ...
                <div class="mb-4">
                    ...
                    <div
                        class="relative border-2 border-gray-400 rounded-md h-9 w-full flex items-center transition-all duration-300 ease-in-out hover:border-gray-800 focus-within:border-gray-800">
                        <input type="date" placeholder="dd/mm/yyyy" id="tanggalSurat" name="tanggal_surat" required
                            class="outline-none tracking-wide px-3 text-sm text-gray-500 flex-grow" />
                        @error('tanggal_surat')
                            <div class="text-red-500 text-left">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="Masukkan keterangan" id="keterangan" name="keterangan" required
                        class="w-full h-9 border-2 border-gray-400 rounded-md px-3 text-sm text-stone-900 font-normal tracking-wide transition focus:border-gray-800 hover:border-gray-800 focus:outline-none">
                    @error('keterangan')
                        <div class="text-red-500 text-left">{{ $message }}</div>
                    @enderror
