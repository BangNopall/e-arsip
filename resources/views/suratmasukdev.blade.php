    ...
    <div class="h-screen">
        ...
        <div class="flex flex-col px-4 py-6">
            ...
            <div class="overflow-x-auto overflow-y-auto mt-2 max-w-full max-h-96">
                    ...
                    <table class="min-w-full min-w-max border">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 border text-sm">
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border text-center truncate">{{ date('d/m/Y', strtotime($d->tanggal_surat)) }}</td>
                                ...
                                <td class="py-2 px-2 text-center"
                                    ...
                                    <form action="{{ route('dashboard.surat-masuk.edit', ['id' => $d->id]) }}" method="GET">
                                        <button type="submit" class="text-white bg-blue-500 rounded-md text-xs font-bold tracking-wide px-4 py-0.5 mr-2">Edit</button>
                                    </form>
                                    <a href="#"
                ...
                @else
                    <div class="text-center text-lg font-semibold my-12">
                        Tidak ada data
                    </div>
                @endif
